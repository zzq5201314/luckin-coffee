 ...
 * @LastEditTime: 2022-12-27 14:39:31
  ...
  >
    ...
    <view class="p-3 bg-white rounded-lg ">
      ...
      <view
        ...
        :key="index"
        class="flex items-center py-3 border-0 border-b border-solid border-gray-100 gap-4"
...
export default {
  ...
  methods: {
    ...
    select (aid) {
      ...
      console.log("select => this.$Route.query.select == 'true'", this.$Route.query.select == "true")
      console.log("select => this.$Route", this.$Route)
