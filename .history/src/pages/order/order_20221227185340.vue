 ...
 * @LastEditTime: 2022-12-27 18:53:40
      ...
      findOrder(type).then(response => {
        ...
        if (response.code === 70000) {
          ...
          response.result.forEach(item => {
            ...
            console.log(getGLWZTime(item.updatedAt));
