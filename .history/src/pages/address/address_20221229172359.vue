 ...
 * @LastEditTime: 2022-12-29 17:23:59
  ...
  >
    ...
    >
      ...
      <view
        ...
        :key="index"
        :data-index="index"
        class="flex items-center py-3 px-3 border-0 border-b border-solid border-gray-100 gap-4 relative  overflow-x-scroll addressItem"
