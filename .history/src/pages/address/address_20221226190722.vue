...
<!-- address 页 -->
<template>
  <view class="address bg-bgColor px-2 h-screen">

    <view class="bg-white p-3 rounded-lg">

      <view
        class="flex py-3 border-0 border-b border-solid border-gray-100 text-lg items-center gap-4"
      >
      ...
      <view class="flex py-3 text-lg items-center gap-4">
