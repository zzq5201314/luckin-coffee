 ...
 * @LastEditTime: 2022-12-28 23:23:44
...
<template>
  ...
  >
    ...
    <view
      class="px-3 py-5 bg-white rounded-lg flex flex-col gap-6 text-xl text-gray-500"
    >
    ...
    <view class="fixed bottom-0 left-0 right-0">
      <view class="bg-selectText text-white m-3 rounded-full py-3 text-center">
        退出登录</view>
