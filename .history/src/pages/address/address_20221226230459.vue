 ...
 * @LastEditTime: 2022-12-26 23:04:58
  ...
  <view class="address bg-bgColor p-3">
    ...
    <view class="p-3 bg-white">
      ...
      >
        ...
        <view>
          <view>
            {{ addressList.province }}{{ addressList.city }}{{ addressList.county }}
          </view>
          <view>{{ addressList.addressDetail }}</view>
          <view>{{ addressList.name }} {{ addressList.tel }}</view>
        </view>
