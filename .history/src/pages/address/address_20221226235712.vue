 ...
 * @LastEditTime: 2022-12-26 23:56:24
...
<template>
  <view class="address bg-bgColor p-3">
    ...
    <view class="bottom fixed bottom-0 left-0 right-0 bg-white">
      <view class="text-white bg-selectText py-2   rounded-full text-center">
        新增收货地址</view>
  ...
  onLoad () {
    ...
    uni.getSystemInfo({
      success: (res) => {
        ...
        console.log("onLoad => bottom", bottom)
