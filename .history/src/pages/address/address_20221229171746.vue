 ...
 * @LastEditTime: 2022-12-29 17:17:05
  ...
  >
    ...
    >
      ...
      <view
        ...
        :key="index"
        :data-index="index"
        class="flex items-center py-3 mx-3 border-0 border-b border-solid border-gray-100 gap-4 relative w-full"
      ...
      >
        ...
        <view
          class="remove absolute top-0 right-0 h-full text-white bg-red-600 rounded-r-lg -mr-3 flex justify-center items-center overflow-x-scroll"
        >删除
        </view>
      </view>
