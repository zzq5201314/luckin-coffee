...
<template>
  ...
  >
    ...
    <view class="fixed bottom-0 left-0 right-0 bg-white">
      ...
      <view
        v-if="aid"
        class="bg-white text-red-500 m-2 text-center  py-2 rounded-full text-lg"
      >删除</view>
...
import { addAddress, findAddressInfo, editAddress } from "@/api/address"
export default {
  // name: "address",
  data () {
    return {
  ...
  onLoad () {
    ...
    console.log("onLoad => this.aid", this.aid)
