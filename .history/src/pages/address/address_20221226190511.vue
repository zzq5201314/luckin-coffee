...
<!-- address 页 -->
<template>
  <view class="address bg-bgColor p-2 h-screen">

    <view class="bg-white p-3 rounded-lg">

      <view
        class="flex py-2 border-0 border-b border-solid border-gray-100 text-lg items-center gap-4"
      >
        <view class="w-24">联系人</view>
        <input
          class="flex-auto"
          type="text"
      ...
      <view class="flex py-2 text-lg items-center gap-4">
        <view class="w-24">默认地址</view>
      </view>
