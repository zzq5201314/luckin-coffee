                ...
                >
                  ...
                  <view class="flex flex-col ml-2 w-40">
                    ...
                    <view class="flex justify-between mt-3 items-center ">
                      <text
                        class="text-orange-500 tracking-tighter">{{parseFloat(productItem.price)}}</text>
                      <view class="relative">
                        <text
...
export default {
  ...
  components: { popup },
  computed: {
    ...mapGetters(['shopCartSum', 'shopCartMoney', 'shopCartList', 'numSelectList', 'shopCartCheckAll', 'checkSids'])
  },
  onLoad () {
