 ...
 * @LastEditTime: 2022-12-29 17:21:06
  ...
  >
    ...
    >
      ...
      <view
        ...
        :key="index"
        :data-index="index"
        class="flex items-center py-3 px-3 border-0 border-b border-solid border-gray-100 gap-4 relative overflow-hidden overflow-x-scroll"
