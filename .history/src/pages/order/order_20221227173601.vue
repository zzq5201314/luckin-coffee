 ...
 * @LastEditTime: 2022-12-27 17:36:01
...
<template>
  ...
  >
    ...
    <view
      class="mx-4   overflow-hidden pb-4"
      :style="{height:contentHeight+'px'}"
    >

      <view
        v-if="orderList.length>0"
        class="overflow-y-scroll h-full bg-white p-4 rounded-lg"
      >
        <view
    ...
    uni.getSystemInfo({
      success: (res) => {
        ...
        tabber.boundingClientRect((data) => {
          console.log("tabber.boundingClientRect => data", data)
