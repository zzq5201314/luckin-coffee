 ...
 * @LastEditTime: 2022-12-29 22:39:53
    ...
    <view class="relative">
      ...
      <view class="mt-4 px-2 ">
        <view class="grid grid-cols-5  text-xs text-center mt-3 ">
          ...
          >
            <view
              class="absolute text-white bg-selectText w-5 h-5 flex items-center justify-center top-0  badge border border-solid border-white"
            >
              {{ collect }}</view>
            <view class="iconfont text-4xl">&#xe65f;</view>
            <text>我的收藏</text>
