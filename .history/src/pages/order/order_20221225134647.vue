 ...
 * @LastEditTime: 2022-12-25 13:46:47
...
<template>
  <view class="order bg-bgColor px-4 py-2">
    <view
      class="grid grid-cols-3 gap-3 text-center bg-selectText text-white border-2 border-solid border-selectText rounded-full text-lg sticky"
    >
      <text
