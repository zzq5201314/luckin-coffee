 ...
 * @LastEditTime: 2022-12-29 17:25:37
  ...
  >
    ...
    >
      ...
      >
        ...
        <view
          class="remove absolute top-0 right-0 h-full text-white bg-red-600 border-red-600 border-solid border rounded-r-lg -mr-3 flex justify-center items-center "
        >删除
        </view>
      </view>
